...
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([
  ...
  \****************************************************************/
      /***/ (
        ...
        /* harmony import */ var _overlays_e7b9d6d9_js__WEBPACK_IMPORTED_MODULE_2__ =
        ...
        /* harmony import */ var _ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_7__ =
          __webpack_require__(/*! ./ionic-global-c81d82ab.js */ 7151);
        /* harmony import */ var _theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_8__ =
          __webpack_require__(/*! ./theme-01f3f29c.js */ 3881);
        /* harmony import */ var _index_3ad7f18b_js__WEBPACK_IMPORTED_MODULE_9__ =
          __webpack_require__(/*! ./index-3ad7f18b.js */ 1280);
        /* harmony import */ var _animation_eab5a4ca_js__WEBPACK_IMPORTED_MODULE_10__ =
        ...
        /* harmony import */ var _gesture_controller_314a54f6_js__WEBPACK_IMPORTED_MODULE_13__ =
        ...
        const configureDismissInteraction = (
          triggerEl,
          triggerAction,
          popoverEl,
          parentPopoverEl,
          ...
          dismissCallbacks.forEach(({eventName, callback}) =>
         ...
         */
        const configureTriggerInteraction = (
          triggerEl,
          triggerAction,
          popoverEl,
        ) => {
          ...
          triggerCallbacks.forEach(({eventName, callback}) =>
         ...
         */
        const isTriggerElement = (el) =>
          el.hasAttribute("data-ion-popover-trigger");
              ...
              switch (ev.key) {
                ...
                case "Enter":
                  if (activeElement && isTriggerElement(activeElement)) {
                    const rightEvent = new CustomEvent(
        ...
        const getPopoverPosition = (
          ...
          switch (reference) {
            ...
            default:
              ...
              const actualTriggerEl =
                triggerEl ||
                ((_a =
                  customEv === null || customEv === void 0
                    ? void 0
                    : customEv.detail) === null || _a === void 0
                  ? void 0
                  : _a.ionShadowTarget) ||
                (customEv === null || customEv === void 0
                  ? void 0
           ...
           */
          const alignedCoordinates = calculatePopoverAlign(
            align,
            side,
            referenceCoordinates,
            contentWidth,
        ...
        const calculatePopoverSide = (
          ...
          const sideRight = {
            top: triggerBoundingBox.top,
            left:
              triggerBoundingBox.left + triggerBoundingBox.width + arrowWidth,
          };
          switch (side) {
            case "top":
              return {
        ...
        const calculateWindowAdjustment = (
          ...
          const triggerHeight = triggerCoordinates
          ...
          if (left < bodyPadding + safeAreaMargin) {
            ...
            contentWidth + bodyPadding + left + safeAreaMargin >
            bodyWidth
          ) {
          ...
          if (
            ...
            if (triggerTop - contentHeight > 0) {
              ...
              top = Math.max(
                12,
                triggerTop - contentHeight - triggerHeight - (arrowHeight - 1),
              );
              arrowTop = top + contentHeight;
              originY = "bottom";
        ...
        const iosEnterAnimation = (baseEl, opts) => {
          ...
          const referenceSizeEl =
            trigger ||
            ((_a = ev === null || ev === void 0 ? void 0 : ev.detail) ===
              null || _a === void 0
              ? void 0
              : _a.ionShadowTarget) ||
            (ev === null || ev === void 0 ? void 0 : ev.target);
          const {contentWidth, contentHeight} = getPopoverDimensions(
            size,
            contentEl,
            referenceSizeEl,
          );
          ...
          _animation_eab5a4ca_js__WEBPACK_IMPORTED_MODULE_10__.c)();
          ...
          return baseAnimation
            ...
            .beforeAddWrite(() => {
              ...
              contentEl.style.setProperty(
                "top",
                `calc(${top}px + var(--offset-y, 0))`,
              );
              contentEl.style.setProperty(
                "left",
                `calc(${leftValue} + var(--offset-x, 0))`,
              );
              contentEl.style.setProperty(
                "transform-origin",
                `${originY} ${originX}`,
              ...
              if (arrowEl !== null) {
                const didAdjustBounds =
                  results.top !== top || results.left !== left;
                ...
                if (showArrow) {
                  arrowEl.style.setProperty(
                    "top",
                    `calc(${arrowTop}px + var(--offset-y, 0))`,
                  );
                  arrowEl.style.setProperty(
                    "left",
                    `calc(${arrowLeft}px + var(--offset-x, 0))`,
                  );
                } else {
        ...
        const Popover = class {
          constructor(hostRef) {
            ...
            this.onBackdropTap = () => {
              this.dismiss(
                undefined,
                _overlays_e7b9d6d9_js__WEBPACK_IMPORTED_MODULE_2__.B,
              );
            };
            ...
            this.configureTriggerInteraction = () => {
              const {trigger, triggerAction, el, destroyTriggerInteraction} =
                this;
              ...
              this.destroyTriggerInteraction = configureTriggerInteraction(
                triggerEl,
                triggerAction,
                el,
              );
            ...
            this.configureKeyboardInteraction = () => {
              ...
              this.destroyKeyboardInteraction =
                configureKeyboardInteraction(el);
            };
            this.configureDismissInteraction = () => {
              ...
              this.destroyDismissInteraction = configureDismissInteraction(
                triggerEl,
                triggerAction,
                el,
                parentPopover,
          ...
          componentWillLoad() {
            ...
            const popoverId =
              (_b =
                ...
                ? _b
                : (0, _overlays_e7b9d6d9_js__WEBPACK_IMPORTED_MODULE_2__.k)(el);
            this.parentPopover = el.closest(`ion-popover:not(#${popoverId})`);
            if (this.alignment === undefined) {
              this.alignment =
                (0, _ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_7__.b)(
                  this,
                ) === "ios"
                  ? "center"
                  : "start";
          ...
          componentDidLoad() {
            ...
            if (parentPopover) {
              (0, _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_4__.a)(
                parentPopover,
                "ionPopoverWillDismiss",
                () => {
          ...
          present(event) {
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              if (
                ...
                yield (0, _index_3ad7f18b_js__WEBPACK_IMPORTED_MODULE_9__.e)(
                  _this2.usersElement,
                );
                /**
              ...
              yield (0, _overlays_e7b9d6d9_js__WEBPACK_IMPORTED_MODULE_2__.f)(
                _this2,
                "popoverEnter",
                iosEnterAnimation,
                mdEnterAnimation,
          ...
          dismiss(data, role, dismissParentPopover = true) {
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              const {destroyKeyboardInteraction, destroyDismissInteraction} =
                _this3;
              if (dismissParentPopover && _this3.parentPopover) {
                _this3.parentPopover.dismiss(data, role, dismissParentPopover);
              }
              const shouldDismiss = yield (0,
              _overlays_e7b9d6d9_js__WEBPACK_IMPORTED_MODULE_2__.g)(
                _this3,
                data,
                role,
                "popoverLeave",
              ...
              if (shouldDismiss) {
                 ...
                 * so that this works in vanilla JS apps
                 */
                const {delegate} = _this3.getDelegate();
                yield (0,
           ...
           */
          onDidDismiss() {
            return (0, _overlays_e7b9d6d9_js__WEBPACK_IMPORTED_MODULE_2__.h)(
              this.el,
              "ionPopoverDidDismiss",
            );
          }
          ...
          render() {
            const mode = (0,
            _ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_7__.b)(this);
            const {
              onLifecycle,
              parentPopover,
              dismissOnSelect,
            ...
            const desktop = (0,
            _ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_7__.a)(
              "desktop",
            );
              ...
              Object.assign(
                ...
                htmlAttributes,
                {
                  ...
                  class: Object.assign(
                    Object.assign(
                      {},
                      (0, _theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_8__.g)(
                        this.cssClass,
                      ),
                    ),
                    {
                      ...
                      [_overlays_e7b9d6d9_js__WEBPACK_IMPORTED_MODULE_2__.F]:
                        focusTrap === false,
