  ...
  \******************************************************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ ion_reorder_group: () =>
            /* binding */ ReorderGroup,
          /* harmony export */
        });
        ...
        /* harmony import */ var _index_e2cf2ceb_js__WEBPACK_IMPORTED_MODULE_2__ =
        ...
        /* harmony import */ var _index_5cc724f3_js__WEBPACK_IMPORTED_MODULE_4__ =
        ...
        /* harmony import */ var _haptic_ac164e4c_js__WEBPACK_IMPORTED_MODULE_6__ =
        ...
        const reorderIosCss =
          ":host([slot]){display:none;line-height:0;z-index:100}.reorder-icon{display:block}::slotted(ion-icon){font-size:dynamic-font(16px)}.reorder-icon{font-size:2.125rem;opacity:0.4}";
        const IonReorderIosStyle0 = reorderIosCss;
        const reorderMdCss =
          ":host([slot]){display:none;line-height:0;z-index:100}.reorder-icon{display:block}::slotted(ion-icon){font-size:dynamic-font(16px)}.reorder-icon{font-size:1.9375rem;opacity:0.3}";
        ...
        const Reorder = class {
          ...
          render() {
            ...
            const reorderIcon =
              mode === "ios"
                ? _index_e2cf2ceb_js__WEBPACK_IMPORTED_MODULE_2__.j
                : _index_e2cf2ceb_js__WEBPACK_IMPORTED_MODULE_2__.k;
        ...
        const ReorderGroup = class {
          ...
          connectedCallback() {
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              const contentEl = (0,
              _index_5cc724f3_js__WEBPACK_IMPORTED_MODULE_4__.f)(_this.el);
              if (contentEl) {
                _this.scrollEl = yield (0,
                _index_5cc724f3_js__WEBPACK_IMPORTED_MODULE_4__.g)(contentEl);
              }
          ...
          completeReorder(listOrReorder) {
            ...
            if (
              ...
              (0, _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_5__.r)(() => {
                if (
                  toIndex !== fromIndex &&
                  (listOrReorder === undefined || listOrReorder === true)
                ) {
                  const ref =
                    fromIndex < toIndex
                      ? children[toIndex + 1]
