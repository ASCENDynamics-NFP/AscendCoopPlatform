      ...
      /***/ (
        ...
        function roundToMaxDecimalPlaces(n, ...references) {
          const maxPlaces = Math.max(
            ...references.map((r) => getDecimalPlaces(r)),
          );
        ...
        const Range = class {
          constructor(hostRef) {
            ...
            this.ionKnobMoveStart = (0,
            _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.d)(
              this,
              "ionKnobMoveStart",
              7,
            );
            this.ionKnobMoveEnd = (0,
            _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.d)(
              this,
              "ionKnobMoveEnd",
              7,
            ...
            this.clampBounds = (value) => {
              return (0, _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_3__.j)(
                this.min,
                value,
                this.max,
              );
          ...
          componentWillLoad() {
            ...
            _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_3__.i)(this.el);
          }
          componentDidLoad() {
          ...
          connectedCallback() {
            ...
            const ionContent = (0,
            _index_5cc724f3_js__WEBPACK_IMPORTED_MODULE_2__.f)(this.el);
            this.contentEl =
              (_a =
                ionContent === null || ionContent === void 0
                  ? void 0
                  : ionContent.querySelector(".ion-content-scroll-host")) !==
                null && _a !== void 0
                ? _a
                : ionContent;
          }
          ...
          onMove(detail) {
            ...
            if (contentEl && this.pressedKnob === undefined) {
              ...
              _index_5cc724f3_js__WEBPACK_IMPORTED_MODULE_2__.d)(contentEl);
            }
            /**
          ...
          onEnd(detail) {
            ...
            const currentX =
              (_a = detail.currentX) !== null && _a !== void 0
                ? _a
                : detail.clientX;
            /**
          ...
          get hasLabel() {
            return (
              this.label !== undefined ||
              this.el.querySelector('[slot="label"]') !== null
            );
          }
          renderRangeSlider() {
            var _a;
            ...
            const rtl = (0, _dir_babeabeb_js__WEBPACK_IMPORTED_MODULE_5__.i)(
              this.el,
            );
            ...
            if (this.dualKnobs === false) {
              ...
              if (
                this.valA <
                ((_a = this.activeBarStart) !== null && _a !== void 0
                  ? _a
                  : this.min)
              ) {
                /**
          ...
          render() {
            ...
            const inItem = (0,
            _theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_6__.h)("ion-item", el);
            /**
            ...
            const hasStartContent =
              (hasLabel &&
                (labelPlacement === "start" || labelPlacement === "fixed")) ||
             ...
             */
            const hasEndContent =
              (hasLabel && labelPlacement === "end") || this.hasEndSlotContent;
        ...
        const ratioToValue = (ratio, min, max, step) => {
          ...
          _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_3__.j)(min, value, max);
