        ...
        const Radio = class {
            ...
            this.onClick = () => {
              ...
              if (
                ...
                (radioGroup === null || radioGroup === void 0
                  ? void 0
                  : radioGroup.allowEmptySelection)
              ) {
                this.checked = false;
              } else {
                this.checked = true;
          ...
          connectedCallback() {
            ...
            const radioGroup = (this.radioGroup =
              this.el.closest("ion-radio-group"));
            if (radioGroup) {
              this.updateState();
          ...
          render() {
            ...
            const inItem = (0,
            _theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_4__.h)("ion-item", el);
            return (0, _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)(
        ...
        const RadioGroup = class {
          ...
          connectedCallback() {
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              const header =
                _this3.el.querySelector("ion-list-header") ||
                _this3.el.querySelector("ion-item-divider");
              if (header) {
                const label = (_this3.label =
                  header.querySelector("ion-label"));
                if (label) {
          ...
          onKeydown(ev) {
            ...
            const inSelectInterface =
              !!this.el.closest("ion-select-popover") ||
              !!this.el.closest("ion-select-modal");
          ...
          setFocus() {
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              const radioToFocus = _this4
                .getRadios()
                .find((r) => r.tabIndex !== -1);
              radioToFocus === null || radioToFocus === void 0
                ? void 0
