  ...
  \******************************************************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ ion_segment_button: () =>
            /* binding */ SegmentButton,
          /* harmony export */
        });
        ...
        /* harmony import */ var _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! ./helpers-da915de8.js */ 4284);
        /* harmony import */ var _dir_babeabeb_js__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(/*! ./dir-babeabeb.js */ 319);
        /* harmony import */ var _theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_4__ =
        ...
        const Segment = class {
          constructor(hostRef) {
            ...
            this.getSegmentButton = (selector) => {
              ...
              switch (selector) {
                ...
                case "next":
                  return (_a = buttons[currIndex + 1]) !== null && _a !== void 0
                    ? _a
                    : buttons[0];
                case "previous":
                  return (_b = buttons[currIndex - 1]) !== null && _b !== void 0
                    ? _b
          ...
          checkButton(previous, current) {
            ...
            const previousClientRect =
              previousIndicator.getBoundingClientRect();
          ...
          getSegmentView() {
            ...
            const segmentContent = document.querySelector(
              `ion-segment-content[id="${firstContentId === null || firstContentId === void 0 ? void 0 : firstContentId.contentId}"]`,
            );
            // Return the segment view for that matching segment content
            return segmentContent === null || segmentContent === void 0
              ? void 0
              : segmentContent.closest("ion-segment-view");
          }
          handleSegmentViewScroll(ev) {
            ...
            if (
              ev.composedPath().includes(segmentViewEl) ||
              (dispatchedFrom === null || dispatchedFrom === void 0
                ? void 0
                : dispatchedFrom.contains(segmentEl))
            ) {
              const buttons = this.getButtons();
          ...
          scrollActiveButtonIntoView(smoothScroll = true) {
            ...
            if (scrollable) {
              ...
              if (activeButton !== undefined) {
                 ...
                 */
                const activeButtonLeft =
                  activeButtonBox.x - scrollContainerBox.x;
                /**
                ...
                const centeredX =
                  activeButtonLeft -
                  scrollContainerBox.width / 2 +
                  activeButtonBox.width / 2;
                /**
          ...
          setNextIndex(detail, isEnd = false) {
            const rtl = (0, _dir_babeabeb_js__WEBPACK_IMPORTED_MODULE_3__.i)(
              this.el,
            );
            ...
            const decreaseIndex = rtl
              ? currentX > left + width
              : currentX < left;
            const increaseIndex = rtl
              ? currentX < left
              : currentX > left + width;
          ...
          onKeyDown(ev) {
            ...
            switch (ev.key) {
              case "ArrowRight":
                ev.preventDefault();
                current = rtl
                  ? this.getSegmentButton("previous")
                  : this.getSegmentButton("next");
                break;
              case "ArrowLeft":
                ev.preventDefault();
                current = rtl
          ...
          render() {
            ...
            return (0, _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)(
              _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.f,
              {
                ...
                class: (0, _theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_4__.c)(
                  this.color,
                  {
                    [mode]: true,
                    "in-toolbar": (0,
                    _theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_4__.h)(
                      "ion-toolbar",
                      this.el,
                    ),
                    "in-toolbar-color": (0,
        ...
        const SegmentButton = class {
          ...
          connectedCallback() {
            ...
            if (segmentEl) {
              this.updateState();
              (0, _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_2__.a)(
                segmentEl,
                "ionSelect",
                this.updateState,
              );
            ...
            if (!segmentContent) {
              console.error(
                `Segment Button: Unable to find Segment Content with id="${this.contentId}".`,
              );
              return;
            }
            ...
            if (segmentContent.tagName !== "ION-SEGMENT-CONTENT") {
              console.error(
                `Segment Button: Element with id="${this.contentId}" is not an <ion-segment-content> element.`,
              );
              return;
            }
          ...
          disconnectedCallback() {
            ...
            if (segmentEl) {
              (0, _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_2__.b)(
                segmentEl,
                "ionSelect",
                this.updateState,
              );
          ...
          componentWillLoad() {
            this.inheritedAttributes = Object.assign(
              {},
              (0, _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_2__.h)(
                this.el,
                ["aria-label"],
              ),
            );
          ...
          render() {
            ...
            const mode = (0,
            _ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_5__.b)(this);
            const hasSegmentColor = () =>
              (segmentEl === null || segmentEl === void 0
                ? void 0
                : segmentEl.color) !== undefined;
            return (0, _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)(
              _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.f,
              {
