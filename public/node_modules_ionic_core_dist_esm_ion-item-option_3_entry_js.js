  ...
  \**********************************************************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ ion_item_options: () =>
            /* binding */ ItemOptions,
          /* harmony export */ ion_item_sliding: () =>
            /* binding */ ItemSliding,
          /* harmony export */
        });
        ...
        /* harmony import */ var _theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! ./theme-01f3f29c.js */ 3881);
        /* harmony import */ var _ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_3__ =
        ...
        /* harmony import */ var _index_5cc724f3_js__WEBPACK_IMPORTED_MODULE_5__ =
          __webpack_require__(/*! ./index-5cc724f3.js */ 4609);
        /* harmony import */ var _watch_options_c2911ace_js__WEBPACK_IMPORTED_MODULE_6__ =
        ...
        const ItemOption = class {
          ...
          render() {
            ...
            const mode = (0,
            _ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_3__.b)(this);
            const attrs =
              TagType === "button"
                ? {
                    type: this.type,
            ...
            return (0, _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)(
              _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.f,
              {
                ...
                class: (0, _theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_2__.c)(
                  this.color,
                  {
                    [mode]: true,
        ...
        const ItemOptions = class {
          ...
          render() {
            ...
            _ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_3__.b)(this);
            const isEnd = (0,
            _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_4__.n)(this.side);
            return (0, _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)(
              _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.f,
              {
        ...
        const ItemSliding = class {
          ...
          connectedCallback() {
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              _this2.contentEl = (0,
              _index_5cc724f3_js__WEBPACK_IMPORTED_MODULE_5__.f)(el);
              /**
               ...
               */
              _this2.mutationObserver = (0,
              _watch_options_c2911ace_js__WEBPACK_IMPORTED_MODULE_6__.w)(
                el,
                "ion-item-option",
                /*#__PURE__*/ (0,
                _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              yield _this2.updateOptions();
              _this2.gesture = (yield Promise.resolve(/*! import() */).then(
          ...
          open(side) {
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
               ...
               */
              const item = (_this3.item =
                (_a = _this3.item) !== null && _a !== void 0
                  ? _a
                  : _this3.el.querySelector("ion-item"));
              if (item === null) {
                return;
              }
              ...
              side = (0, _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_4__.n)(
                side,
              )
                ? "end"
                : "start";
              ...
              requestAnimationFrame(() => {
                ...
                const width =
                  side === "end"
                    ? _this3.optsWidthRightSide
                    : -_this3.optsWidthLeftSide;
          ...
          updateOptions() {
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              for (let i = 0; i < options.length; i++) {
                ...
                const option =
                  item.componentOnReady !== undefined
                    ? yield item.componentOnReady()
                    : item;
                const side = (0,
                _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_4__.n)(
                  option.side,
                )
                  ? "end"
                  : "start";
          ...
          onStart() {
            ...
            if (contentEl) {
              ...
              _index_5cc724f3_js__WEBPACK_IMPORTED_MODULE_5__.d)(contentEl);
            }
          ...
          onMove(gesture) {
            ...
            if (openAmount > this.optsWidthRightSide) {
              ...
              openAmount =
                optsWidth + (openAmount - optsWidth) * ELASTIC_FACTOR;
          ...
          onEnd(gesture) {
            ...
            if (contentEl) {
              (0, _index_5cc724f3_js__WEBPACK_IMPORTED_MODULE_5__.r)(
                contentEl,
            ...
            if (
              swipeShouldReset(isResetDirection, isMovingFast, isOnCloseZone)
            ) {
              restingPoint = 0;
            }
            ...
            if (
              (state & 32) /* SlidingState.SwipeEnd */ !== 0 &&
              this.rightOptions
            ) {
              this.rightOptions.fireSwipeEvent();
            } else if (
              (state & 64) /* SlidingState.SwipeStart */ !== 0 &&
              this.leftOptions
            ) {
              ...
              _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.f,
              {
                ...
                class: {
                  ...
                  "item-sliding-active-options-end":
                    (this.state & 8) /* SlidingState.End */ !== 0,
                  "item-sliding-active-options-start":
                    (this.state & 16) /* SlidingState.Start */ !== 0,
                  "item-sliding-active-swipe-end":
                    (this.state & 32) /* SlidingState.SwipeEnd */ !== 0,
                  "item-sliding-active-swipe-start":
                    (this.state & 64) /* SlidingState.SwipeStart */ !== 0,
                },
              },
            );
          }
