  ...
  \**********************************************************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ ion_picker_column: () =>
            /* binding */ PickerColumn,
          /* harmony export */
        });
        ...
        /* harmony import */ var _haptic_ac164e4c_js__WEBPACK_IMPORTED_MODULE_4__ =
        ...
        const PickerColumn = class {
          constructor(hostRef) {
            ...
            this.initializeScrollListener = () => {
               ...
               */
              const enableHaptics = (0,
              _ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_5__.a)("ios");
              ...
              const scrollCallback = () => {
                (0, _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_3__.r)(() => {
                  ...
                  if (!this.isScrolling) {
                    enableHaptics &&
                      (0, _haptic_ac164e4c_js__WEBPACK_IMPORTED_MODULE_4__.a)();
                  ...
                  const referenceNode = hasParentShadow
                    ? rootNode
                    : _index_a5d50daf_js__WEBPACK_IMPORTED_MODULE_2__.d;
                  /**
                   ...
                   */
                  const newActiveElement = elementsAtPoint.find(
                    (el) => el.tagName === "ION-PICKER-COLUMN-OPTION",
                  );
                  ...
                  if (newActiveElement !== activeEl) {
                    enableHaptics &&
                      (0, _haptic_ac164e4c_js__WEBPACK_IMPORTED_MODULE_4__.b)();
                  ...
                  if (this.updateValueTextOnScroll) {
                    (_a = this.assistiveFocusable) === null || _a === void 0
                      ? void 0
                      : _a.setAttribute(
                          "aria-valuetext",
                          this.getOptionValueText(newActiveElement),
                        );
                  }
                  timeout = setTimeout(() => {
                    this.isScrolling = false;
                    ...
                    enableHaptics &&
                      (0, _haptic_ac164e4c_js__WEBPACK_IMPORTED_MODULE_4__.h)();
                    /**
            ...
            this.findNextOption = (stride = 1) => {
              ...
              while (node != null) {
                ...
                if (
                  node.tagName === "ION-PICKER-COLUMN-OPTION" &&
                  !node.disabled &&
                  stride === 0
                ) {
                  return node;
            ...
            this.onKeyDown = (ev) => {
               ...
               */
              const mobile = (0,
              _ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_5__.a)(
                "mobile",
              );
              let newOption = null;
              switch (ev.key) {
                ...
                case "PageUp":
                  newOption = mobile
                    ? this.findNextOption(5)
                    : this.findPreviousOption(5);
                  break;
                case "PageDown":
                  newOption = mobile
                    ? this.findPreviousOption(5)
                ...
                case "Home":
                   ...
                   */
                  newOption = this.el.querySelector(
            ...
            this.getOptionValueText = (el) => {
              var _a;
              return el
                ? (_a = el.getAttribute("aria-label")) !== null && _a !== void 0
                  ? _a
                  : el.innerText
                : "";
            };
          ...
          componentWillLoad() {
            ...
            const visibleCallback = (entries) => {
              ...
              if (ev.isIntersecting) {
                ...
                _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_3__.g)(
                  el,
                ).querySelector(`.${PICKER_ITEM_ACTIVE_CLASS}`);
                if (oldActive) {
            ...
            if (parentEl !== null) {
              // TODO(FW-2832): type
              parentEl.addEventListener("ionInputModeChange", (ev) =>
                this.inputModeChange(ev),
              );
            }
          }
          ...
          connectedCallback() {
            var _a;
            this.ariaLabel =
              (_a = this.el.getAttribute("aria-label")) !== null &&
              _a !== void 0
                ? _a
                : "Select a value";
          }
          ...
          render() {
            ...
            return (0, _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)(
              _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.f,
              {
                ...
                class: (0, _theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_6__.c)(
                  color,
                  {
                    [mode]: true,
