  ...
  \****************************************************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ ion_route_redirect: () =>
            /* binding */ RouteRedirect,
        ...
        const RouteRedirect = class {
          constructor(hostRef) {
            ...
            this.ionRouteRedirectChanged = (0,
            _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.d)(
              this,
        ...
        const writeSegments = (
          ...
          const url = generateUrl(
            [...parsePath(root).segments, ...segments],
            useHash,
            queryString,
          );
        ...
        const _writeNavState = /*#__PURE__*/ (function () {
          ...
          _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
            ...
            try {
              ...
              const result = yield outlet.setRouteId(
                route.id,
                route.params,
                direction,
                animation,
            ...
            if (routeId.params) {
              ...
              if (routeIdParams.length === routeChain.segments.length) {
                ...
                for (let j = 0; j < pathWithParams.length; j++) {
                  ...
                  if (
                    pathWithParams[j].toLowerCase() !== routeChain.segments[j]
                  ) {
                    break;
                  }
          ...
          if (match) {
            return match.map((route, i) => {
              ...
              return {
                ...
                params: mergeParams(
                  route.params,
                  (_a = ids[i]) === null || _a === void 0 ? void 0 : _a.params,
                ),
              };
            });
          }
        ...
        const Router = class {
          constructor(hostRef) {
            ...
            this.ionRouteWillChange = (0,
            _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.d)(
              this,
              "ionRouteWillChange",
              7,
            );
            this.ionRouteDidChange = (0,
            _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.d)(
              this,
              "ionRouteDidChange",
              7,
          ...
          componentDidLoad() {
            window.addEventListener(
              "ionRouteRedirectChanged",
              (0, _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_2__.o)(
          ...
          push(path, direction = "forward", animation) {
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              if (path.startsWith(".")) {
                const currentPath =
                  (_a = _this4.previousPath) !== null && _a !== void 0
                    ? _a
                    : "/";
              ...
              return _this4.writeNavStateRoot(
                parsedPath.segments,
                direction,
                animation,
              );
          ...
          navChanged(direction) {
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              yield _this6.safeWriteNavState(
                outlet,
                chain,
                ROUTER_INTENT_NONE,
                segments,
          ...
          onRedirectChanged() {
            ...
            if (
              segments &&
              findRouteRedirect(segments, readRedirects(this.el))
            ) {
          ...
          historyDirection() {
            ...
            if (win.history.state === null) {
              ...
              win.history.replaceState(
                this.state,
                win.document.title,
                (_a = win.document.location) === null || _a === void 0
                  ? void 0
                  : _a.href,
              );
            }
          ...
          writeNavStateRoot(segments, direction, animation) {
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              // write DOM give
              return _this7.safeWriteNavState(
                document.body,
                chain,
                direction,
                segments,
          ...
          safeWriteNavState(
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              let changed = false;
              try {
                changed = yield _this8.writeNavState(
                  node,
                  chain,
                  direction,
                  segments,
          ...
          runGuards(to = this.getSegments(), from) {
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              const beforeLeaveHook =
                fromChain && fromChain[fromChain.length - 1].beforeLeave;
              ...
              // eslint-disable-next-line @typescript-eslint/prefer-optional-chain
              const beforeEnterHook =
                toChain && toChain[toChain.length - 1].beforeEnter;
          ...
          writeNavState(
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              const routeEvent = _this11.routeChangeEvent(
                segments,
                redirectFrom,
              );
              if (routeEvent) {
              ...
              const changed = yield _writeNavState(
                node,
                chain,
                direction,
                index,
          ...
          routeChangeEvent(toSegments, redirectFromSegments) {
            ...
            const redirectedFrom = redirectFromSegments
              ? generatePath(redirectFromSegments)
              : null;
            return {
              from,
              redirectedFrom,
