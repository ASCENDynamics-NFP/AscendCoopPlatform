...
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([
  ...
  \**************************************************************/
      /***/ (
        ...
        /* harmony import */ var _config_49c88215_js__WEBPACK_IMPORTED_MODULE_2__ =
        ...
        /* harmony import */ var _lock_controller_316928be_js__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(/*! ./lock-controller-316928be.js */ 2554);
        /* harmony import */ var _index_9b0d46f4_js__WEBPACK_IMPORTED_MODULE_5__ =
          __webpack_require__(/*! ./index-9b0d46f4.js */ 2461);
        /* harmony import */ var _overlays_e7b9d6d9_js__WEBPACK_IMPORTED_MODULE_6__ =
        ...
        /* harmony import */ var _animation_eab5a4ca_js__WEBPACK_IMPORTED_MODULE_9__ =
          __webpack_require__(/*! ./animation-eab5a4ca.js */ 6446);
        /* harmony import */ var _index_a5d50daf_js__WEBPACK_IMPORTED_MODULE_10__ =
          __webpack_require__(/*! ./index-a5d50daf.js */ 7688);
        /* harmony import */ var _index_39782642_js__WEBPACK_IMPORTED_MODULE_11__ =
        ...
        function getAnimationPosition(position, positionAnchor, mode, toast) {
          ...
          if (
            positionAnchor &&
            _index_a5d50daf_js__WEBPACK_IMPORTED_MODULE_10__.w
          ) {
            ...
            if (position === "top") {
               ...
               */
              offset -=
                _index_a5d50daf_js__WEBPACK_IMPORTED_MODULE_10__.w.innerHeight -
                box.top;
            }
            /**
        ...
        function warnIfAnchorIsHidden(positionAnchor, toast) {
          if (positionAnchor.offsetParent === null) {
            (0, _index_9b0d46f4_js__WEBPACK_IMPORTED_MODULE_5__.p)(
        ...
        const iosEnterAnimation = (baseEl, opts) => {
          ...
          _animation_eab5a4ca_js__WEBPACK_IMPORTED_MODULE_9__.c)();
          const wrapperAnimation = (0,
          _animation_eab5a4ca_js__WEBPACK_IMPORTED_MODULE_9__.c)();
          const {position, top, bottom} = opts;
          const root = (0, _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_3__.g)(
            baseEl,
          );
          ...
          switch (position) {
            case "top":
              ...
              break;
            case "middle":
              const topPosition = getOffsetForMiddlePosition(
                baseEl.clientHeight,
        ...
        const createSwipeToDismissGesture = (el, toastPosition, onDismiss) => {
           ...
           */
          const wrapperEl = (0,
          _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_3__.g)(
            el,
          ).querySelector(".toast-wrapper");
          ...
          const swipeAnimation = (0,
          _animation_eab5a4ca_js__WEBPACK_IMPORTED_MODULE_9__.c)(
            "toast-swipe-to-dismiss-animation",
          )
          ...
          const onEnd = (detail) => {
            ...
            const threshold =
              ((detail.deltaY + velocity * 1000) / MAX_SWIPE_DISTANCE) *
              INVERSION_FACTOR;
            /**
            ...
            if (el.position === "middle") {
              ...
              const endOffset =
                (topPosition + wrapperElBox.height) * offsetFactor;
              /**
            ...
            const duration = Math.min(
              Math.abs(remainingDistance) / Math.abs(velocity),
              200,
            );
            swipeAnimation
              .onFinish(
          ...
          const gesture = (0,
          _index_39782642_js__WEBPACK_IMPORTED_MODULE_11__.createGesture)({
            el: wrapperEl,
            gestureName: "toast-swipe-to-dismiss",
            gesturePriority:
              _overlays_e7b9d6d9_js__WEBPACK_IMPORTED_MODULE_6__.O,
            /**
        ...
        const Toast = class {
          constructor(hostRef) {
            ...
            _overlays_e7b9d6d9_js__WEBPACK_IMPORTED_MODULE_6__.d)(this);
            this.lockController = (0,
            _lock_controller_316928be_js__WEBPACK_IMPORTED_MODULE_4__.c)();
            this.triggerController = (0,
            _overlays_e7b9d6d9_js__WEBPACK_IMPORTED_MODULE_6__.e)();
            this.customHTMLEnabled =
              _ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_8__.c.get(
                "innerHTMLTemplatesEnabled",
                _config_49c88215_js__WEBPACK_IMPORTED_MODULE_2__.E,
              );
            this.presented = false;
            this.dispatchCancelHandler = (ev) => {
              const role = ev.detail.role;
              if (
                (0, _overlays_e7b9d6d9_js__WEBPACK_IMPORTED_MODULE_6__.i)(role)
              ) {
            ...
            this.createSwipeGesture = (toastPosition) => {
              const gesture = (this.gesture = createSwipeToDismissGesture(
                this.el,
                toastPosition,
                () => {
                  /**
                  ...
                  this.dismiss(
                    undefined,
                    _overlays_e7b9d6d9_js__WEBPACK_IMPORTED_MODULE_6__.G,
                  );
                },
              ));
              gesture.enable(true);
            ...
            this.duration =
              _ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_8__.c.getNumber(
                "toastDuration",
                0,
              );
          ...
          componentWillLoad() {
            ...
            if (
              ...
              (0, _overlays_e7b9d6d9_js__WEBPACK_IMPORTED_MODULE_6__.k)(
                this.el,
              );
            }
          }
          ...
          present() {
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              const {el, position} = _this;
              const anchor = _this.getAnchorElement();
              const animationPosition = getAnimationPosition(
                position,
                anchor,
                (0, _ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_8__.b)(
                  _this,
                ),
                el,
              );
              ...
              yield (0, _overlays_e7b9d6d9_js__WEBPACK_IMPORTED_MODULE_6__.f)(
                _this,
                "toastEnter",
                iosEnterAnimation,
                mdEnterAnimation,
              ...
              if (_this.duration > 0) {
                _this.durationTimeout = setTimeout(
                  () => _this.dismiss(undefined, "timeout"),
                  _this.duration,
                );
              }
              /**
          ...
          dismiss(data, role) {
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              const {durationTimeout, position, lastPresentedPosition} = _this2;
              if (durationTimeout) {
              ...
              _overlays_e7b9d6d9_js__WEBPACK_IMPORTED_MODULE_6__.g)(
                 ...
                 */
                {
                  ...
                  top:
                    (_a =
                      lastPresentedPosition === null ||
                      lastPresentedPosition === void 0
                        ? void 0
                        : lastPresentedPosition.top) !== null && _a !== void 0
                      ? _a
                      : "",
                  bottom:
                    (_b =
                      ...
                      lastPresentedPosition === void 0
                        ? void 0
                        : lastPresentedPosition.bottom) !== null &&
                    _b !== void 0
                      ? _b
                      : "",
                },
           ...
           */
          onDidDismiss() {
            return (0, _overlays_e7b9d6d9_js__WEBPACK_IMPORTED_MODULE_6__.h)(
              this.el,
              "ionToastDidDismiss",
            );
          }
          ...
          getAnchorElement() {
            ...
            if (typeof positionAnchor === "string") {
              ...
              if (foundEl === null) {
                (0, _index_9b0d46f4_js__WEBPACK_IMPORTED_MODULE_5__.p)(
                  `An anchor element with an ID of "${positionAnchor}" was not found in the DOM.`,
                  el,
                );
                return undefined;
              }
          ...
          callButtonHandler(button) {
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              if (
                button === null || button === void 0 ? void 0 : button.handler
              ) {
                // a handler has been provided, execute it
                // pass the handler the values from the inputs
                try {
                  const rtn = yield (0,
                  _overlays_e7b9d6d9_js__WEBPACK_IMPORTED_MODULE_6__.s)(
                    button.handler,
                  );
                  if (rtn === false) {
            ...
            return (0, _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)(
              ...
              buttons.map((b) =>
                (0, _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)(
                  "button",
                  Object.assign({}, b.htmlAttributes, {
                    type: "button",
                    class: buttonClass(b),
                    tabIndex: 0,
            ...
            if (customHTMLEnabled) {
              return (0, _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)(
                "div",
                {
                  ...
                  part: "message",
                  innerHTML: (0,
                  _config_49c88215_js__WEBPACK_IMPORTED_MODULE_2__.a)(message),
                },
              );
            }
            return (0, _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)(
          ...
          render() {
            const {layout, el, revealContentToScreenReader, header, message} =
              this;
              ...
              (0, _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)(
                ...
                (0, _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)(
                  ...
                  (0, _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)(
                    ...
                    revealContentToScreenReader &&
                      message !== undefined &&
                      this.renderToastMessage("header"),
                  ),
        ...
        const buttonPart = (button) => {
          return (0, _overlays_e7b9d6d9_js__WEBPACK_IMPORTED_MODULE_6__.i)(
            button.role,
          )
            ? "button cancel"
            : "button";
