  ...
  \********************************************************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ ion_accordion_group: () =>
            /* binding */ AccordionGroup,
          /* harmony export */
        });
        ...
        /* harmony import */ var _index_e2cf2ceb_js__WEBPACK_IMPORTED_MODULE_3__ =
        ...
        const Accordion = class {
          constructor(hostRef) {
            ...
            this.setAria = (expanded = false) => {
               ...
               */
              const root = (0,
              _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_2__.g)(ionItem);
            ...
            this.expandAccordion = (initialUpdate = false) => {
              ...
              if (this.shouldAnimate()) {
                (0, _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_2__.r)(() => {
                  ...
                  this.currentRaf = (0,
                  _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_2__.r)(
                    /*#__PURE__*/ (0,
                    _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
                      ...
                      const waitForTransition = (0,
                      _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_2__.t)(
                        contentEl,
                        2000,
                      );
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              if (shouldExpand) {
                ...
                const nextAccordionValue =
                  nextAccordion === null || nextAccordion === void 0
                    ? void 0
                    : nextAccordion.value;
                if (nextAccordionValue !== undefined) {
                  _this.isPrevious = Array.isArray(value)
                    ? value.includes(nextAccordionValue)
                    : value === nextAccordionValue;
                }
                const previousAccordion = _this.getPreviousSibling();
                const previousAccordionValue =
                  previousAccordion === null || previousAccordion === void 0
                    ? void 0
                    : previousAccordion.value;
                if (previousAccordionValue !== undefined) {
                  _this.isNext = Array.isArray(value)
            ...
            this.getNextSibling = () => {
              ...
              if (
                (nextSibling === null || nextSibling === void 0
                  ? void 0
                  : nextSibling.tagName) !== "ION-ACCORDION"
              ) {
                return;
              }
              return nextSibling;
            ...
            this.getPreviousSibling = () => {
              ...
              if (
                (previousSibling === null || previousSibling === void 0
                  ? void 0
                  : previousSibling.tagName) !== "ION-ACCORDION"
              ) {
                return;
              }
          ...
          connectedCallback() {
            ...
            const accordionGroupEl = (this.accordionGroupEl =
              (_a = this.el) === null || _a === void 0
                ? void 0
                : _a.closest("ion-accordion-group"));
            if (accordionGroupEl) {
          ...
          toggleExpanded() {
            ...
            if (accordionGroupEl) {
               ...
               */
              const expand =
                state === 1 /* AccordionState.Collapsed */ ||
...
`,
          ...
          onKeydown(ev) {
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              const startingIndex = accordions.findIndex(
                (a) => a === accordionEl,
              );
              if (startingIndex === -1) {
                return;
              ...
              if (ev.key === "ArrowDown") {
                ...
                accordion = _this4.findPreviousAccordion(
                  accordions,
                  startingIndex,
                );
              } else if (ev.key === "Home") {
          ...
          requestAccordionToggle(accordionValue, accordionExpand) {
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              const {multiple, value, readonly, disabled} = _this6;
              ...
              if (accordionExpand) {
                ...
                if (multiple) {
                  ...
                  const processedValue = Array.isArray(groupValue)
                    ? groupValue
                    : [groupValue];
                  const valueExists = processedValue.find(
                    (v) => v === accordionValue,
                  );
                  if (
                ...
                if (multiple) {
                  ...
                  const processedValue = Array.isArray(groupValue)
                    ...
                    : [groupValue];
                  _this6.setValue(
                    processedValue.filter((v) => v !== accordionValue),
                  );
                } else {
          ...
          getAccordions() {
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              return Array.from(
                _this7.el.querySelectorAll(":scope > ion-accordion"),
              );
            })();
          }
          render() {
