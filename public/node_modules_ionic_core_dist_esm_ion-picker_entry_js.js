        ...
        const Picker = class {
          constructor(hostRef) {
            ...
            this.isInHighlightBounds = (ev) => {
               ...
               */
              const outsideX =
                ev.clientX < bbox.left || ev.clientX > bbox.right;
              const outsideY =
            ...
            this.onFocusOut = (ev) => {
              ...
              if (
                !relatedTarget ||
                (relatedTarget.tagName !== "ION-PICKER-COLUMN" &&
            ...
            this.onPointerDown = (ev) => {
              ...
              if (this.isInHighlightBounds(ev)) {
                ...
                if (useInputMode) {
                   ...
                   */
                  const columns = el.querySelectorAll(
            ...
            this.enterInputMode = (columnEl, focusInput = true) => {
               ...
               */
              const hasInputColumn = el.querySelector(
                "ion-picker-column.picker-column-numeric-input",
              );
              if (!hasInputColumn) {
                return;
            ...
            this.selectSingleColumn = () => {
              const {inputEl, inputModeColumn, singleColumnSearchTimeout} =
                this;
              if (!inputEl || !inputModeColumn) {
                return;
              }
              const options = Array.from(
                inputModeColumn.querySelectorAll("ion-picker-column-option"),
              ...
              const findItemFromCompleteValue = options.find(
                ({textContent}) => {
                   ...
                   */
                  const parsedText = textContent.replace(
                    /^0+(?=[1-9])|0+(?=0$)/,
                    "",
                  );
              ...
              if (inputEl.value.length === 2) {
                const changedCharacter = inputEl.value.substring(
            ...
            this.searchColumn = (colEl, value, zeroBehavior = "start") => {
              ...
              const option = Array.from(
                colEl.querySelectorAll("ion-picker-column-option"),
              ).find((el) => {
                return (
                  el.disabled !== true &&
                  el.textContent.replace(behavior, "") === value
                );
              });
              if (option) {
            ...
            this.selectMultiColumn = () => {
              ...
              const numericPickers = Array.from(
                el.querySelectorAll("ion-picker-column"),
              ...
              switch (value.length) {
                ...
                case 2:
                  ...
                  value =
                    firstCharacter === "0" || firstCharacter === "1"
                      ? inputEl.value
                      : firstCharacter;
                  this.searchColumn(firstColumn, value);
                  /**
                   ...
                   */
                  if (value.length === 1) {
                    minuteValue = inputEl.value.substring(
                      inputEl.value.length - 1,
                    );
                ...
                case 4:
                   ...
                   * at that first.
                   */
                  const firstCharacterAgainAgain = inputEl.value.substring(
                    0,
                    1,
                  );
                  value =
          ...
          componentWillLoad() {
            (0, _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_2__.g)(
              this.el,
          ...
          exitInputMode() {
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              const {inputEl, useInputMode} = _this;
              if (!useInputMode || !inputEl) {
                return;
              }
            ...
            return (0, _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)(
              ...
              (0, _index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)("input", {
                ...
                onKeyDown: (ev) => {
                   ...
                   */
                  if (ev.key === "Enter") {
                    (_a = this.inputEl) === null || _a === void 0
                      ? void 0
                      : _a.blur();
                  }
                },
