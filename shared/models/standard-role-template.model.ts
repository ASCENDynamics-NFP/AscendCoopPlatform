...
export const STANDARD_ROLE_TEMPLATES: StandardRoleTemplate[] = [
  ...
  // Family Category
  {
    ...
    icon: "home",
    isSystemRole: true,
    suggestedChildRoles: ["Great Grandparent", "Grandparent"],
  },
  {
  ...
  {
    id: "std_great_grandparent",
    category: "Family",
    name: "Great Grandparent",
    description: "Elder family member two generations above parents",
    defaultPermissions: ["participate_in_family"],
    applicableGroupTypes: ["Family"],
    icon: "glasses",
    isSystemRole: true,
    suggestedChildRoles: ["Grandparent"],
  },
  {
    id: "std_grandparent",
    category: "Family",
    name: "Grandparent",
    description: "Parent of a parent within the family",
    defaultPermissions: ["participate_in_family"],
    applicableGroupTypes: ["Family"],
    icon: "person",
    isSystemRole: true,
    suggestedChildRoles: ["Parent", "Aunt", "Uncle"],
  },
  {
    id: "std_parent",
    category: "Family",
    name: "Parent",
    description: "Direct guardian responsible for children",
    defaultPermissions: ["participate_in_family"],
    applicableGroupTypes: ["Family"],
    icon: "male-female",
    isSystemRole: true,
    suggestedChildRoles: ["Child"],
  },
  {
    id: "std_aunt",
    category: "Family",
    name: "Aunt",
    description: "Sibling of a parent",
    defaultPermissions: ["participate_in_family"],
    applicableGroupTypes: ["Family"],
    icon: "woman",
    isSystemRole: true,
    suggestedChildRoles: ["Cousin"],
  },
  {
    id: "std_uncle",
    category: "Family",
  ...
  },
  {
    ...
    category: "Family",
    name: "Child",
    description: "Direct offspring of a parent",
    defaultPermissions: ["participate_in_family"],
    applicableGroupTypes: ["Family"],
    icon: "happy-outline",
    isSystemRole: true,
    suggestedChildRoles: ["Grandchild"],
  },
  {
    id: "std_cousin",
    category: "Family",
    name: "Cousin",
    description: "Child of a parent's sibling",
    defaultPermissions: ["participate_in_family"],
    applicableGroupTypes: ["Family"],
    icon: "people-outline",
    isSystemRole: true,
