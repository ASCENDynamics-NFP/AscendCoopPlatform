...
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([
  ...
  \**************************************************************/
      /***/ (
        ...
        /* harmony import */ var _index_3ad7f18b_js__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(/*! ./index-3ad7f18b.js */ 1280);
        /* harmony import */ var _ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_5__ =
          __webpack_require__(/*! ./ionic-global-c81d82ab.js */ 7151);
        /* harmony import */ var _framework_delegate_63d1a679_js__WEBPACK_IMPORTED_MODULE_6__ =
          __webpack_require__(/*! ./framework-delegate-63d1a679.js */ 1097);
        /* harmony import */ var _index_9b0d46f4_js__WEBPACK_IMPORTED_MODULE_7__ =
        ...
        class ViewController {
          ...
          init(container) {
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              if (!_this.element) {
                ...
                _this.element = yield (0,
                _framework_delegate_63d1a679_js__WEBPACK_IMPORTED_MODULE_6__.a)(
                  _this.delegate,
                  container,
                  component,
           ...
           */
          _destroy() {
            (0, _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_3__.m)(
        ...
        const matches = (view, id, params) => {
          ...
          return (0, _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_3__.s)(
            view.params,
            params,
          );
        };
        ...
        const Nav = class {
          ...
          componentWillLoad() {
            ...
            if (this.swipeGesture === undefined) {
              const mode = (0,
              _ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_5__.b)(this);
              this.swipeGesture =
                _ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_5__.c.getBoolean(
                  "swipeBackEnabled",
                  mode === "ios",
                );
            }
          ...
          componentDidLoad() {
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              _this2.didLoad = true;
              _this2.rootChanged();
              _this2.gesture = (yield __webpack_require__
                .e(/*! import() */ "common")
                .then(
          ...
          disconnectedCallback() {
            for (const view of this.views) {
              (0, _index_3ad7f18b_js__WEBPACK_IMPORTED_MODULE_4__.l)(
                view.element,
                _index_3ad7f18b_js__WEBPACK_IMPORTED_MODULE_4__.d,
              );
              view._destroy();
            }
          ...
          popTo(indexOrViewCtrl, opts, done) {
            ...
            if (
              typeof indexOrViewCtrl === "object" &&
              indexOrViewCtrl.component
            ) {
          ...
          setRouteId(id, params, direction, animation) {
            ...
            if (direction === "root") {
              ...
              const viewController = this.views.find((v) =>
                matches(v, id, params),
              );
              if (viewController) {
                finish = this.popTo(
                  viewController,
                  Object.assign(Object.assign({}, commonOpts), {
                    direction: "back",
          ...
          queueTrns(ti, done) {
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              var _a, _b;
              if (
                _this9.isTransitioning &&
                ((_a = ti.opts) === null || _a === void 0
                  ? void 0
                  : _a.skipIfBusy)
              ) {
                return false;
              ...
              // Normalize empty
              if (
                ((_b = ti.insertViews) === null || _b === void 0
                  ? void 0
                  : _b.length) === 0
              ) {
          ...
          success(result, ti) {
            ...
            if (ti.opts.updateURL !== false && this.useRouter) {
              ...
              if (router) {
                const direction =
                  result.direction === "back" ? "back" : "forward";
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              try {
                ...
                if (requiresTransition && ti.opts && leavingView) {
                   ...
                   */
                  if (isBackDirection) {
                    ti.opts.animationBuilder =
                      ti.opts.animationBuilder ||
                      (enteringView === null || enteringView === void 0
                        ? void 0
                        : enteringView.animationBuilder);
                  }
                  leavingView.animationBuilder = ti.opts.animationBuilder;
                }
                let result;
                if (requiresTransition) {
                  result = yield _this10.transition(
                    enteringView,
                    leavingView,
                    ti,
                  );
          ...
          prepareTI(ti) {
            ...
            (_b = (_c = ti.opts).delegate) !== null && _b !== void 0
              ? _b
              : (_c.delegate = this.delegate);
            if (ti.removeView !== undefined) {
              (0, _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_3__.m)(
                ti.removeStart !== undefined,
                "removeView needs removeStart",
              );
              (0, _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_3__.m)(
                ti.removeCount !== undefined,
            ...
            if (ti.removeStart !== undefined) {
              ...
              ti.leavingRequiresTransition =
                ti.removeCount > 0 &&
                ti.removeStart + ti.removeCount === viewsLength;
            }
            if (ti.insertViews) {
          ...
          postViewInit(enteringView, leavingView, ti) {
            ...
            if (removeStart !== undefined && removeCount !== undefined) {
              ...
              (_a = opts.direction) !== null && _a !== void 0
                ? _a
                : (opts.direction = "back");
            }
            const finalNumViews =
              this.views.length +
              ((_b =
                insertViews === null || insertViews === void 0
                  ? void 0
                  : insertViews.length) !== null && _b !== void 0
                ? _b
                : 0) -
              (removeCount !== null && removeCount !== void 0
                ? removeCount
                : 0);
            (0, _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_3__.m)(
              finalNumViews >= 0,
            ...
            if (insertViews) {
              ...
              if (ti.enteringRequiresTransition) {
                ...
                (_c = opts.direction) !== null && _c !== void 0
                  ? _c
            ...
            if (destroyQueue && destroyQueue.length > 0) {
              for (const view of destroyQueue) {
                (0, _index_3ad7f18b_js__WEBPACK_IMPORTED_MODULE_4__.l)(
                  view.element,
                  _index_3ad7f18b_js__WEBPACK_IMPORTED_MODULE_4__.b,
                );
                (0, _index_3ad7f18b_js__WEBPACK_IMPORTED_MODULE_4__.l)(
                  view.element,
                  _index_3ad7f18b_js__WEBPACK_IMPORTED_MODULE_4__.c,
                );
                (0, _index_3ad7f18b_js__WEBPACK_IMPORTED_MODULE_4__.l)(
                  view.element,
                  _index_3ad7f18b_js__WEBPACK_IMPORTED_MODULE_4__.d,
            ...
            _Users_marcinufniarz_Desktop_ASCENDynamicsNFP_ascendcoopplatform_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              const progressCallback = opts.progressAnimation
                ? (ani) => {
                    ...
                    if (
                      ani !== undefined &&
                      !_this11.gestureOrAnimationInProgress
                    ) {
                ...
                : undefined;
              const mode = (0,
              _ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_5__.b)(
                _this11,
              );
              ...
              const animationOpts = Object.assign(
                ...
                ),
                {
                  animationBuilder:
                    ...
                    _this11.animation ||
                    _ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_5__.c.get(
                      "navAnimation",
                    ),
                },
              );
              const {hasCompleted} = yield (0,
              _index_3ad7f18b_js__WEBPACK_IMPORTED_MODULE_4__.t)(animationOpts);
              return _this11.transitionFinish(
                hasCompleted,
                enteringView,
                leavingView,
                opts,
          ...
          removeView(view) {
            (0, _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_3__.m)(
              view.state === VIEW_STATE_ATTACHED ||
                view.state === VIEW_STATE_DESTROYED,
            ...
            for (let i = views.length - 1; i >= 0; i--) {
              ...
              if (element) {
                if (i > activeViewIndex) {
                  ...
                  (0, _index_3ad7f18b_js__WEBPACK_IMPORTED_MODULE_4__.s)(
                    element,
                    true,
                  );
                }
