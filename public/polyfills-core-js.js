        ...
        !(function (t) {
          ...
          !(function (t) {
              ...
              t.exports =
                ...
                ("__proto__" in {}
                  ? (function () {
                      ...
                      return function (e, i) {
                        return (
                          r(e), o(i), n ? t.call(e, i) : (e.__proto__ = i), e
                        );
                      };
                    })()
                  : void 0);
                ...
                },
                {
                  matchAll: function (t) {
                    ...
                    if (null != t) {
                      if (
                        s(t) &&
                        !~String(i("flags" in E ? t.flags : l.call(t))).indexOf(
                          "g",
                        )
                      )
                        throw TypeError(
            ...
            function (t, n, e) {
              var r = e(54);
              t.exports =
                /Version\/10\.\d+(\.\d+)?( Mobile\/\w+)? Safari\//.test(r);
            },
            function (t, n, e) {
              var r = e(2),
                o = e(210).start;
                    ...
                    [
                      ...
                      function (t, o) {
                        ...
                        for (var b = 0, S = 0, E = []; S < p.length; ) {
                          ...
                          if (
                            null === O ||
                            (w = v(f(x.lastIndex + (g ? 0 : S)), p.length)) ===
                              b
                          )
                            S = c(p, S, d);
                          else {
                            if ((E.push(p.slice(b, S)), E.length === m))
                              return E;
