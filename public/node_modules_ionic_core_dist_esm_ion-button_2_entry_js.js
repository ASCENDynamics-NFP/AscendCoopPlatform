  ...
  \*****************************************************************/
      /***/ (
        ...
        const getNamedUrl = (iconName, iconEl) => {
          ...
          try {
            return (0, _index_28849c61_js__WEBPACK_IMPORTED_MODULE_0__.k)(
              `svg/${iconName}.svg`,
            );
          } catch (e) {
            /**
        ...
        const Button = class {
          constructor(hostRef) {
            ...
            this.handleClick = (ev) => {
              ...
              if (this.type === "button") {
                ...
                (0, _helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_1__.l)(el)
              ) {
                this.submitForm(ev);
              }
            };
          ...
          renderHiddenButton() {
            ...
            if (formEl) {
              ...
              const newFormButtonEl = (this.formButtonEl =
          ...
          get rippleType() {
            const hasClearFill =
              this.fill === undefined || this.fill === "clear";
            ...
            if (typeof form === "string") {
              ...
              if (el) {
                if (el instanceof HTMLFormElement) {
                   ...
                   */
                  (0, _index_9b0d46f4_js__WEBPACK_IMPORTED_MODULE_2__.p)(
          ...
          render() {
            ...
            const finalSize =
              size === undefined && this.inItem ? "small" : size;
        ...
        const Icon = class {
          ...
          render() {
            ...
            const shouldAutoFlip = iconName
              ? (iconName.includes("arrow") || iconName.includes("chevron")) &&
                flipRtl !== false
              : false;
